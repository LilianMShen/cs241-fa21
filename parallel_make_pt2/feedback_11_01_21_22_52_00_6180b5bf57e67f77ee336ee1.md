...
**Scheduled**: 11-01-21 22:52:00  
**Revision**: bc3de59509f20a1c0a3e40bff6e57ca7dfeb7778  
**Score**: **22.26666666666667** out of **41.0** points
...
```
Failed to correctly execute multiple dependencies in parallel on more complex makefile (or extra printouts)
```
---
...
```
Most outputs were in the correct order, but not all.
```
---
...
Good performance! (took: 0.667s, limit: 0.8s)
```
---
