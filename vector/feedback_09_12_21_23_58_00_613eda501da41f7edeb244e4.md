...
==194==    by 0x400DE4: vector_push_back (in /tmp/tmp7xk8xspl/vector_test)
==194==    by 0x40216F: check_memory (in /tmp/tmp7xk8xspl/vector_test)
==194==    by 0x40472B: main (in /tmp/tmp7xk8xspl/vector_test)
==194== 
==194== 9 bytes in 9 blocks are definitely lost in loss record 2 of 2
==194==    at 0x4C33B25: calloc (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
==194==    by 0x400B04: vector_resize (in /tmp/tmp7xk8xspl/vector_test)
==194==    by 0x4020C0: check_memory (in /tmp/tmp7xk8xspl/vector_test)
==194==    by 0x40472B: main (in /tmp/tmp7xk8xspl/vector_test)
==194== 
==194== LEAK SUMMARY:
