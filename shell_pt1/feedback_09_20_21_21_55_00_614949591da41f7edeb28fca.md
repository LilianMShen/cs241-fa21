...
==191== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==191== Command: ./shell
==191== Parent PID: 7
==191== 
==191== Invalid write of size 1
==191==    at 0x40107C: getInput (in /tmp/tmp7o9zxmk0/shell)
==191==    by 0x401706: runUserInput (in /tmp/tmp7o9zxmk0/shell)
==191==    by 0x40197D: shell (in /tmp/tmp7o9zxmk0/shell)
==191==    by 0x401CA5: main (in /tmp/tmp7o9zxmk0/shell)
==191==  Address 0x55ce16f is 1 bytes before a block of size 100 alloc'd
==191==    at 0x4C31B0F: malloc (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
==191==    by 0x400FE4: getInput (in /tmp/tmp7o9zxmk0/shell)
==191==    by 0x401706: runUserInput (in /tmp/tmp7o9zxmk0/shell)
==191==    by 0x40197D: shell (in /tmp/tmp7o9zxmk0/shell)
==191==    by 0x401CA5: main (in /tmp/tmp7o9zxmk0/shell)
==191== 
...
==191==   total heap usage: 5 allocs, 5 frees, 8,404 bytes allocated
==191== 
...
f9122834390fa707e98031142ed23a5bbdad7d87 shell.c
