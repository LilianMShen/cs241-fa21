...
==190==    at 0x40107C: getInput (in /tmp/tmpmwe0mijd/shell)
==190==    by 0x401706: runUserInput (in /tmp/tmpmwe0mijd/shell)
==190==    by 0x40197D: shell (in /tmp/tmpmwe0mijd/shell)
==190==    by 0x401CA5: main (in /tmp/tmpmwe0mijd/shell)
==190==  Address 0x55ce16f is 1 bytes before a block of size 100 alloc'd
==190==    at 0x4C31B0F: malloc (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
==190==    by 0x400FE4: getInput (in /tmp/tmpmwe0mijd/shell)
==190==    by 0x401706: runUserInput (in /tmp/tmpmwe0mijd/shell)
==190==    by 0x40197D: shell (in /tmp/tmpmwe0mijd/shell)
==190==    by 0x401CA5: main (in /tmp/tmpmwe0mijd/shell)
==190== 
...
==190==   total heap usage: 5 allocs, 5 frees, 8,404 bytes allocated
==190== 
